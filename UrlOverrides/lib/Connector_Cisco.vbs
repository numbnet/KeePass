...
If objFSO.FileExists("..\Plugins\PuTTY\putty.exe") Then putty = """..\Plugins\PuTTY\putty.exe"""
If putty = "" then WScript.Echo "putty not found at:" & vbCrLf & "1. C:\windows\system32\putty.exe" & vbCrLf & "2. C:\Program Files (x86)\PuTTY\putty.exe" & vbCrLf & "3. C:\Program Files\PuTTY\putty.exe" & vbCrLf & "4. ..\Plugins\PuTTY\putty.exe"
